...
const ParallaxCtaLeftImageV2 = ({ title, content, image, cta }) => {
	...
	return (
		<Container className="mt-10 md:mt-32 max-md:mb-10">
			<div
				ref={containerRef}
				className="relative flex w-full flex-col-reverse gap-x-12 md:flex-row md:items-center"
			>
...
const ParallaxCtaLeftImageV2Container = ({ data }) => {
	const widgetData = {
	...
	return <ParallaxCtaLeftImageV2 {...widgetData} />
}

export default ParallaxCtaLeftImageV2Container
