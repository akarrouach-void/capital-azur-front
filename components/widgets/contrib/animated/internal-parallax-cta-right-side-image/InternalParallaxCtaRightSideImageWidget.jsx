...
export const InternalParallaxCtaRightSideImage = ({ title, content, image, cta }) => {
	...
	return (
		<div className="relative md:h-[80vh]">
			<div className="mr-auto h-full p-10 md:mb-0 md:flex md:w-1/2 md:items-center md:pr-16">
				<motion.div
					initial="initial"
					whileInView="animate"
					viewport={{ once: true }}
			...
			<div
				...
				className="relative right-0 top-0 h-96 overflow-hidden bg-gray-100 md:absolute md:h-full md:w-1/2"
			>
				<motion.img
...
const InternalParallaxCtaRightSideImageContainer = ({ data }) => {
	const widgetData = {
	...
	return <InternalParallaxCtaRightSideImage {...widgetData} />
}

export default InternalParallaxCtaRightSideImageContainer
