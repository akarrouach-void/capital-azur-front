...
const RightSideImageCtaBottomAnimation = ({ title, content, image, cta }) => {
	...
	return (
		<div className="flex flex-col-reverse gap-x-5 py-10 md:flex-row md:gap-x-10">
			...
			<div className="relative mb-6 flex-1 md:mb-0">
...
const RightSideImageCtaBottomAnimationContainer = ({ data }) => {
	const widgetData = {
	...
	return <RightSideImageCtaBottomAnimation {...widgetData} />
}
export default RightSideImageCtaBottomAnimationContainer
